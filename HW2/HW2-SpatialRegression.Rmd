...
moran_val <- moran(data$LNMEDHVAL, queenlist, n=length(queenlist$neighbours), S0=Szero(queenlist))$`I` 
...
ggplot()+
  geom_histogram(aes(moranMCres),binwidth = 0.005)+
  xlim(-1,1)+
  geom_vline(xintercept=moran_val,color='red',linewidth=1)+
