...
### Morans I plot 1 Option 2

This is the code he gave us to the the Moran's I plot. This looks quite ugly and is hard to read so I decided to to do the plot using ggplot which resulted in the code above. I am little concerned that the location of the points in the ggplot graph do not quite match what we get in this plot. Would like to discuss which one we use!

```{r warning=FALSE, message=FALSE, cache=FALSE}

moran.plot(data$resnb, queenlist)
```
