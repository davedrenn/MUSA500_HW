...
For these three tests the null hypothesis is that of homoscedasticity. If the p-value is less than 0.05 then we can reject the null hypothesis for the alternative hypothesis of heteroscedasticity.
