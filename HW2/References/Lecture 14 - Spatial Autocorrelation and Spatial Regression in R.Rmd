...
```{r warning=FALSE, message=FALSE, cache=FALSE}
shp <-st_read(dsn ="C:\\Users\\eugeneby\\Dropbox\\Documents\\Work and School\\Teaching\\CPLN 671 - Statistics and Data Mining\\2023_MUSA_5000_GitHub\\Homework Assignments\\HW 1\\Lecture 1 - RegressionData.shp")
```
